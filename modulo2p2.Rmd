...
residui sia costante in tutto il dominio di studio
...
-   A volte vengono utilizzate condizioni al contorno nell’area (punti
    fittizi) che non rispecchiano dati reali misurati.  Raramente
    vengono applicati più modelli di stima allo stesso set di dati ed
    effettuato il confronto fra le varianze di stima.
