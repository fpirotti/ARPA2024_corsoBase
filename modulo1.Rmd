...
-   principali Tipo dati: oggetti e funzioni in R
...
-   Crea una funzione che esegue la seguente operazione:
    -   Crea un oggetto data.frame con 2 colonne, (Stazione, ValoreX) e
        4 righe. Calcola una terza colonna con il quadrato di ValoreX.
-   
...
Impareremo a leggere/scrivere in R dati semplici da fonti diverse:
...
Oggigiorno i dati JSON sono molto utilizzati per trasferire dati non
strutturati.
...
Chiamata anche "data wrangling" fondamentalmente è la trasformazione
delle strutture dati (e.g. da liste a tabelle e viceversa, aggregando e
disaggregando dati...).
...
Mappando a tibble abbiamo solo colonne di tipo character... come mai?\*
...
sfondo territoriale e considerare delle colonne come coordinate?
...
ggplot(dtf.geo) + geom_sf() + coord_sf()
```
