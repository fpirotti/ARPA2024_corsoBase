...
Esportare un foglio excel ed un file CSV separato da TAB. Nominateli
*es2_cognome_nome.xlsx* e *es2_cognome_nome.csv* rispettivamente.
...
colonne, creare sommari e statistiche di interesse aggreando dati.
...
## Convertire tipologie di colonne
...
colonna. TRANNE che per la colonna valore. Perchè?\*\*
...
[pagina QUI](https://gdal.org/drivers/vector/index.html)
...
QUI](https://gdal.org/drivers/raster/index.html)
