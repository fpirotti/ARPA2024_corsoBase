...
Se troviamo delle covariate (e.g. quota che spiega la temperatura)
possiamo inserirle nel modello per eliminarne gli effetti ed isolare.

NB: se ignoriamo la relazione temperatura - quota, vediamo la
direzionalità.

### "Non" soddisfa criterio di isotropia

## Variabili regionalizzate - finestra
