...
lag. Se il variogramma è delimitato (raggiunge un massimo tetto (sill)
di varianza) si può decidere che i dati sono stazionari, ma se il
...
-   Vicino più prossimo (Nearest Neighbour - NN) - poligoni di Thiessen
    danno l'area di influenza. $$ Z*= Z_i$$ Dove $Z_i$ è il vicino più
    prossimo e $Z_*$ il punto da interpolare

## Vicino Naturale (Natural Neighbour - NatN)

-   Vicino Naturale (Natural Neighbour - NatN) - poligoni di Thiessen
    danno l'area di influenza.
...
-   IWD (inverso pesato sulla distanza)
...
# Risposte alle domande {.Section1 .titlepage}
